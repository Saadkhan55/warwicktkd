    ...
    <!--Add header including logo, and navbar elements -->
      ...
      <div class="container gallery">
        ...
        <div class="gallery-set">
          ...
          <div class="row">
            <div class="col-md-3">
              <a class="gallery" href="#"><img src="images/placeholder.png" class="img-responsive"></a> <!--anchor link with image inside -->
            </div> <!-- End of col -->
          
            <div class="col-md-3">
              <a class="gallery" href="#"><img src="images/placeholder.png" class="img-responsive"></a>
            </div> <!-- End of col -->
        ...
        </div> <!-- End of gallery-set -->

        <!--Gallery set stores pictures with similar proprties such as from the same event-->
        <div class="gallery-set">
          <h2 class="title">GTUK - 2014</h2>
          <!--3 Images per row-->
          <div class="row">
            <div class="col-md-3">
              <a class="gallery" href="#"><img src="images/placeholder.png" class="img-responsive"></a> <!--anchor link with image inside -->
