...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
      ...
      <div class="team">
        <div class="container">
          <h2 class="section">Meet the Team</h2>
          <!-- Each row contains 2 individual-->

          <div id="2014" class="new-exec hidden">
            <div class="row">
              <div class="col-md-6 individual animated bounceInLeft ">
                <img class="img-responsive" src="images/team/2014/Chris.jpg" width="150px" height="150px">
              ...
              <div class="col-md-6 individual animated bounceInRight ">
                <img class="img-responsive" src="images/team/2014/Alex.jpg" width="150px" height="150px">
            ...
            <div class="row"> <!-- New row -->
              <div class="col-md-6 individual animated bounceInLeft ">
                <img class="img-responsive" src="images/team/2014/Sian.jpg" width="150px" height="150px">
              ...
              <div class="col-md-6 individual animated bounceInRight ">
                <img class="img-responsive" src="images/team/2014/Roliver.jpg" width="150px" height="150px">
            ...
            <div class="row">
              <div class="col-md-6 individual animated bounceInLeft ">
                <img class="img-responsive" src="images/team/2014/Bendy.jpg" width="150px" height="150px">
              ...
              <div class="col-md-6 individual animated bounceInRight ">
                <img class="img-responsive" src="images/team/2014/Leigh.jpg" width="150px" height="150px">
            ...
            <div class="row">
              <div class="col-md-6 individual animated bounceInLeft ">
                <img class="img-responsive" src="images/team/2014/Jess.jpg" width="150px" height="150px">
              ...
              <div class="col-md-6 individual animated bounceInRight ">
                <img class="img-responsive" src="images/team/2014/Sophie.jpg" width="150px" height="150px">
